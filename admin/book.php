...
$query = "SELECT * FROM book"; // Fetch from the book table
    ...
    <div class="container-fluid">
        <div class="row mb-4">
            <div class="col-lg-9 text-center mx-auto">
                <h1 class="page-header" style="font-weight:bold;">Books Table</h1>
                <button class="button mt-3">
                    <a href="insert_book.php" style="color: #fff; text-decoration: none;">Add More</a>
                </button>
            </div>
            ...
            <div class="col-lg-10 mx-auto">
                ...
                <div class="table-responsive">
                    <table id="books-table" class="table display">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Book Name</th>
                                <th>Description</th>
                                <th>Book Picture</th> <!-- New column for image -->
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td data-label="ID"><?php echo htmlspecialchars($book['b_id']); ?></td>
                                <td data-label="Book Name"><?php echo htmlspecialchars($book['b_name']); ?></td>
                                <td data-label="Description"><?php echo $book['b_descr']; ?></td>

                                <!-- Display Book Image -->
                                <td data-label="Book Picture">
                                    <img class="award-img" src="images/<?php echo htmlspecialchars($book['b_pic']); ?>" alt="Book Image"  width="100">
                                </td>

                                <!-- Display Link -->
                                <td data-label="Link">
                                    <a href="<?php echo htmlspecialchars($book['b_link']); ?>" target="_blank">
                                        <?php echo htmlspecialchars($book['b_link']); ?>
                                    </a>
                                </td>

                                <td>
                                    <a class="button update" href="update_book.php?id=<?php echo $book['b_id']; ?>">
                                        <i class="fa fa-pencil"></i> Update
                                    </a>
                                </td>
                               <td>
    <a href="delete_book.php?id=<?php echo $book['b_id']; ?>" class="button">
        <div class="trash">
            <div class="top">
                <div class="paper"></div>
            </div>
