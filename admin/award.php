...
$query = "SELECT * FROM award"; // Adjust table name and columns as needed
    ...
    <div class="container-fluid">
        <div class="row mb-4">
            <div class="col-lg-9 text-center mx-auto">
                <h1 class="page-header" style="font-weight:bold;">Awards Box</h1>
                <button class="button mt-3">
                    <a href="insert_award.php" style="color: #fff; text-decoration: none;">Add More</a>
                </button>
            </div>
            ...
            <div class="col-lg-8 mx-auto">
                ...
                <div class="table-responsive">
                    <table id="awards-table" class="table display">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Award Name</th>
                                <th>Awards</th> <!-- New column for image -->
                                <th>Update</th>
                                <th>Delete</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                <td data-label="ID"><?php echo htmlspecialchars($award['aw_id']); ?></td>
                                <td data-label="Award Name"><?php echo htmlspecialchars($award['aw_name']); ?></td>
                                
                                <!-- Display Award Image -->
                                <td data-label="Award Picture">
                                    <img class="award-img" src="images/<?php echo htmlspecialchars($award['aw_pic']); ?>" alt="Award Image">
                                </td>

                                <td>
                                    <a class="button update" href="update_award.php?id=<?php echo $award['aw_id']; ?>">
                                        <i class="fa fa-pencil"></i> Update
                                    </a>
                                </td>
                               <td>
    <a href="delete_award.php?id=<?php echo $award['aw_id']; ?>" class="button">
        <div class="trash">
            <div class="top">
                <div class="paper"></div>
            </div>
