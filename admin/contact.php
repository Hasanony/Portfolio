...
// Update the `seen` column to 1 for all unseen messages
$sql = "UPDATE contact SET seen = 1 WHERE seen = 0";

if ($conn->query($sql) === TRUE) {
    // Optional: Display a message or log that the update was successful
    // echo "All unseen messages marked as seen.";
} else {
    echo "Error updating records: " . $conn->error;
}
$query = "SELECT * FROM contact"; // Escaped 'column' table with backticks
    ...
    <div class="container-fluid">
        <div class="row mb-4">
            <div class="col-lg-9 text-center mx-auto">
                <h1 class="page-header" style="font-weight:bold;">Messages</h1>
    ...
    <table id="content-table" class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo htmlspecialchars($row['msz']); ?></td>
                <td>
                    <a class="button update" href="update_column.php?id=<?php echo $row['id']; ?>" style="display:flex">
                        <i class="fa fa-comment-dots"></i>&nbsp; Reply
                    </a>
                </td>
