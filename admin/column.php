...
// Fetch data from the 'column' table (adjust table name if needed)
$query = "SELECT * FROM `column`"; // Escaped 'column' table with backticks
    ...
    <div class="container-fluid">
        <div class="row mb-4">
            <div class="col-lg-9 text-center mx-auto">
                <h1 class="page-header" style="font-weight:bold;">Columns</h1>
                <button class="button dele mt-3">
                    <a href="insert_column.php" style="color: #fff; text-decoration: none;">Add New Column</a>
                </button>
            </div>
    ...
    <table id="content-table" class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><img src="images/<?php echo htmlspecialchars($row['c_pic']); ?>" alt="Content Image" width="100"></td>
                <td><?php echo htmlspecialchars($row['c_date']); ?></td>
                <td>
                    <a class="button update" href="update_column.php?id=<?php echo $row['c_id']; ?>" style="display:flex">
                        <i class="fa fa-pencil"></i> Update
                    </a>
                </td>
              <td>
<a href="delete_column.php?id=<?php echo $row['c_id']; ?>" class="button">
    <div class="trash">
        <div class="top">
            <div class="paper"></div>
        </div>
